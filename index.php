...
<html lang="en">
  <head>
    ...
    <title>Report IT Support - Yongconcrete</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" style="text-align:center;" class="site_title"><i class="fa fa-calculator"></i> <span>Report IT Support</span></a>
            </div>
